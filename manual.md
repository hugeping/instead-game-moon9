...
Команды, которые требуют больше чем два существительных, в игре не используются.
...
В играх с текстовым вводом, кроме команды "осмотреть" можно также "смотреть в" и "смотреть под". Но в игре "Луна-9" эти возможности не используются.
...
Поздравляю, теперь вы готовы! Спасибо за чтение этого небольшого руководства и приятной игры!

## Контакты

Если вам понравилась игра и вас интересуют другие похожие игры, или вам захотелось написать отзыв автору игры:

https://instead-games.ru
