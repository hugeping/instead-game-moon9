...
room {
	...
	before_Wait = function(s)
		if dark_side() and _'comp'.speed > 2.0 then
			p(string.format("Скорость Арго-3 составляет %.02f км/с. Если не снизить скорость, то после того как корабль обогнёт обратную сторону Луны, он направится обратно к Земле. Не время ждать -- время действовать!"))
			return
		end
