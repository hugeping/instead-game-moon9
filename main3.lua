...
cutscene {
	...
	next_to = 'кресло';
	exit = [[Ты медленно пробуждаешься ото сна. Пристёгнутый к креслу в довольно неудобной для сна позе, ты несколько секунд смотришь сквозь носовые иллюминаторы. Часть обзора загораживает посадочный модуль. А на фоне его ты видшь яркий, заполняющий всё лунный свет.]];
}
...
obj {
	...
	ClipOff = function(s)
		p [[Ты расстёгиваешь ремни и вылываешь из кресла.]]
		walkout 'модуль'
	end;
