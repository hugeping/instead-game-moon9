...
room {
	...
	n_to = 'sklad';
	dsc = function(s)
		p [[В жилом модуле установлены кровати. Ты можешь вернуться в служебный модуль на юг или пройти в складской модуль на север.]]
	end;
}:with {
	Prop { -"стены,стена" };
	Path {
...
room {
	...
	s_to = 'liv';
	dsc = function(s)
		p [[В складском модуле работает дежурное освещение. Ты можешь выйти в жилой модуль на юг.]]
	end;
}
