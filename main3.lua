...
obj {
	...
	description = function(s)
		if last_chance then
			...
			читается боль и мольба. Её глаза. Они жгут твою совесть.]]
			enable 'глаза'
		else
...
obj {
	...
	dsc = function(s)
		...
		if s.step < 1 then
			...
			p [[Ты видишь недалеко от себя космонавта, держащего в руках кусок алюминевой трубы. Он готовится атаковать!]];
		end
	end;
}:with {
	obj {
		nam = 'труба';
		-"труба";
		description = [[Кусок алюминевой трубы от какой-то несущей рамы.]];
		before_Take = function(s)
