...
room {
	...
	dsc = function(s)
		p [[Ты находишься в гостиной. Сквозь закрытые окна ты видишь ночную тьму.]];
		if seen 'жена' then
...
cutscene {
	...
	text = {
		[[-- Да, слушаю!^
		-- Борис, извини, что так поздно. Но тут такое дело... Придётся стартовать раньше. Тебе нужно завтра приехать.]];
		[[-- Завтра? Что произошло?^
		-- Я понимаю, выходные... Но у нас ЧП... Потеряна связь с 8-й. Мы думали, это временные проблемы, но они не выходят на связь уже 2 дня. И нет оснований считать, что выйдут. Никаких сигналов от них.]];
		[[-- Что это может означать? Метеорит?^
		-- Мы не знаем. Принято решение перенести старт Луны-9 как можно ближе. Китайцы настаивают, да и мы хотим помочь ребятам, если... Если они ещё живы.]];
		[[-- Когда?^
		-- Приезжай, всё расскажем. И.. Передай Ларисе мои извинения... У тебя всё в порядке? Голос какой-то...]];
...
cutscene {
	nam = 'title';
	title = "Луна-9";
	dsc = [[11 ноября 2043 года пилотируемый космический корабль Луна-9 успешно достиг орбиты Луны. На 17 дней раньше ранее запланированного срока.^^
	Командир: Борис Громов^
	Пилот командного модуля: Сергей Чернов^
	Пилот лунного модуля: Александр Катаев^^
	Миссия: cмена вахты на российско-китайской лунной базе "Луна-7". Выяснение причины пропажи сигнала, спасение экипажа "Луна-8".
	]];
}