...
cutscene {
	...
	ощутимо подбрасывало на неровностях ландшафта. С некоторой тревогой вы приближались к странным розовым клубам пара.]];
	[[Наконец, на полной скорости вы въехали в розовое облако. Видимость стала заметно хуже, но вы уверенно шли на сигнал навигационного маяка по пеленгатору.]];
